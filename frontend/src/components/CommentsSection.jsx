...
const Comment = ({ comment, postId, depth = 0, isReply = false, parentCommenter }) => {
  ...
  const sortedReplies = comment.replies? [...comment.replies].sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)): [];
            ...
            <div className="flex items-center space-x-2 mt-2">
              ...
              <div className="flex-1 relative">
                ...
                <div className="flex items-center text-xs text-gray-500 mb-1">
                  ...
                  <span className="font-semibold">{comment.commenter?.name}</span>
                </div>
                <input
                  type="text"
                  value={replyText}
                  onChange={(e) => setReplyText(e.target.value)}
                  onKeyPress={(e) => handleReplyKeyPress(e, comment._id, "comment")}
